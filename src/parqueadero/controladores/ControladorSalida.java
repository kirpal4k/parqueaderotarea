...
public class ControladorSalida implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
         ...
         //vehiculo=consultasVehiculo.buscarVehiculo(Integer.parseInt(vistasalida.valortarifa.getText()))
         ...
         try{
             ...
             if(consultasCliente.actualizarCliente(cliente)){
                  JOptionPane.showMessageDialog(null, "Exito retirando, se quedo: "+tiempoEnEscuderia+" el total de tu Cuenta seria: "+tiempoEnEscuderia*10);
             }else{
